    ...
    <div className="newsCard p-10">
      ...
      <div className="newsCard gap-8 w-fit">
        ...
        <div className="newsContent flex  flex-col gap-3 justify-between p-5 border border-gray-200 rounded-b-lg">
          ...
          <h3 className="text-3xl font-black mb-2.5 leading-none">
            Maecenas tempor urna sed quam mollis, a placerat <br /> dui fringill
            Suspendisse.
          </h3>
        </div>
        ...
        <div>
          ...
          <p className="text-gray-400 text-xl py-5">
            ...
            tempus maximus. Fusce <br /> malesuada sed velit ut dictum. Morbi
            faucibus vitae orci at euismod. Integer auctor augue in <br /> erat
            vehicula, quis fermentum ex finibus.
          </p>

          <p className="text-gray-400 text-xl ">
            Mauris pretium elit a dui pulvinar, in ornare sapien euismod. Nullam
            interdum nisl ante, id feugiat <br /> quam euismod commodo. Sed
            ultrices lectus ut iaculis rhoncus. Aenean non dignissim justo, at{" "}
            <br /> fermentum turpis. Sed molestie, ligula ut molestie ultrices,
            tellus ligula viverra neque, malesuada <br /> consectetur diam
            sapien volutpat risus. Quisque eget tortor lobortis, facilisis metus
            eu, <br /> elementum est. Nunc sit amet erat quis ex convallis
        ...
        <p className="text-gray-400 text-xl">
          ...
          vehicula ut, vestibulum ut <br /> mauris. Nullam non felis varius dui
          rutrum rutrum in a nisi. Suspendisse elementum rutrum lorem <br /> sed
          luctus. Proin iaculis euismod metus non sollicitudin. Duis vel luctus
          lacus. Nullam faucibus <br /> iaculis convallis. In ullamcorper nibh
          ipsum, eget lacinia eros pulvinar a. Integer accumsan arcu <br /> nec
          faucibus ultricies.
        </p>
      </div>
      ...
      <div className="relative  w-fit">
        ...
        <div>
          <div className="absolute top-15 left-20">
            ...
            <h2 className="font-bold mb-5 text-white text-3xl">Fresh Fruit</h2>
            <Button
              icon={
                <svg
      ...
      <div className="mt-15">
        ...
        <div className="flex pt-8">
          <div className="">
            <img
              src="src/assets/Images/blogs/pfp1.png"
              className="rounded-full w-13 mr-2"
              alt=""
            />
          </div>
          <div>
            <div className="font-black">Annette Black</div>
        ...
        <hr className="my-5 text-gray-400 w-3/5" />
